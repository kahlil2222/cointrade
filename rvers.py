        ...
        if candles is not None and not candles.empty:
            ...
            try:
                ...
                if profit <= -1 or (avg20["close"].iloc[-1] - max_price)/ max_price * 100 <= -1:
                    ...
                    print("profit:", profit)
                if loc_krw >= 6000 and price >= 50 and (price - premax_price)/ premax_price *100 >= 1:
                    upbit.buy_market_order(value, 6000)
            except KeyError:
                
                if loc_krw >= 6000 and price >= 50 and pre_price < close_preavg20 and price > close_avg20 and volume > vol200 *1.5:
                    upbit.buy_market_order(value, 6000)
                    print(sym)
